...
2. Scripting must be enabled in the dotcms environment. In order to enable this, this variable must be set to true in the dotmarketing-config.properties file
